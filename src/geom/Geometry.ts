 ...
 */
class Geometry {
    // private static  long serialVersionUID = 8763622679187376702L;

    protected static TYPECODE_POINT: number = 0;
    protected static TYPECODE_MULTIPOINT: number = 1;
    protected static TYPECODE_LINESTRING: number = 2;
    protected static TYPECODE_LINEARRING: number = 3;
    protected static TYPECODE_MULTILINESTRING: number = 4;
    protected static TYPECODE_POLYGON: number = 5;
    protected static TYPECODE_MULTIPOLYGON: number = 6;
    protected static TYPECODE_GEOMETRYCOLLECTION: number = 7;

    public static TYPENAME_POINT: string = "Point";
    public static TYPENAME_MULTIPOINT: string = "MultiPoint";
    public static TYPENAME_LINESTRING: string = "LineString";
    public static TYPENAME_LINEARRING: string = "LinearRing";
    public static TYPENAME_MULTILINESTRING: string = "MultiLineString";
    public static TYPENAME_POLYGON: string = "Polygon";
    public static TYPENAME_MULTIPOLYGON: string = "MultiPolygon";
    public static TYPENAME_GEOMETRYCOLLECTION: string = "GeometryCollection";
