...
export class Coordinates {
     ...
     * @return created coordinate
     */
    public static create(dimension: number, measures?: number): Coordinate {
     ...
     */
    public static dimension(coordinate: Coordinate): number {
     ...
     */
    public static measures(coordinate: Coordinate): number {
        if (coordinate instanceof CoordinateXY) {
            return 0;
        } else if (coordinate instanceof CoordinateXYM) {
            return 1;
