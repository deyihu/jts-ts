...
export class Orientation {
     ...
     * A value that indicates an orientation of clockwise, or a right turn.
     */
    public static RIGHT: number = Orientation.CLOCKWISE;
    /**
     * A value that indicates an orientation of counterclockwise, or a left turn.
     */
    public static COUNTERCLOCKWISE: number = 1;
    /**
     * A value that indicates an orientation of counterclockwise, or a left turn.
     */
    public static LEFT: number = Orientation.COUNTERCLOCKWISE;
    /**
     * A value that indicates an orientation of collinear, or no turn (straight).
     */
    public static COLLINEAR: number = 0;
    /**
     * A value that indicates an orientation of collinear, or no turn (straight).
     */
    public static STRAIGHT: number = Orientation.COLLINEAR;
